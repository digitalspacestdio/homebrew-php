...
class Php56Common < Formula
  ...
  depends_on "djocker/php/php56-apcu"
  depends_on "djocker/php/php56-gmp"
  depends_on "djocker/php/php56-igbinary"
  depends_on "djocker/php/php56-imagick"
  depends_on "djocker/php/php56-intl"
  depends_on "djocker/php/php56-mcrypt"
  depends_on "djocker/php/php56-mongodb"
  depends_on "djocker/php/php56-opcache"
  depends_on "djocker/php/php56-pdo-pgsql"
  depends_on "djocker/php/php56-redis"
  depends_on "djocker/php/php56-tidy"
