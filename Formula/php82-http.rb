...
class Php82Http < AbstractPhp82Extension
  init
  ...
  def install
    ...
    mkdir_p "ext/raphf"
    cp "#{Formula["Php82-raphf"].opt_prefix}/include/php_raphf.h", "ext/raphf/php_raphf.h"
    cp "#{Formula["Php82-raphf"].opt_prefix}/include/php_raphf_api.h", "ext/raphf/php_raphf_api.h"

    # link in the propro extension header
    mkdir_p "ext/propro"
    cp "#{Formula["Php82-propro"].opt_prefix}/include/php_propro.h", "ext/propro/php_propro.h"
    cp "#{Formula["Php82-propro"].opt_prefix}/include/php_propro_api.h", "ext/propro/php_propro_api.h"
