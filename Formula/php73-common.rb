...
class Php73Common < Formula
  ...
  depends_on "djocker/php/php73-gmp"
  depends_on "djocker/php/php73-igbinary"
  depends_on "djocker/php/php73-imagick"
  depends_on "djocker/php/php73-intl"
  depends_on "djocker/php/php73-mcrypt"
  depends_on "djocker/php/php73-mongodb"
  depends_on "djocker/php/php73-opcache"
  depends_on "djocker/php/php73-pdo-pgsql"
  depends_on "djocker/php/php73-sodium"
  depends_on "djocker/php/php73-redis"
  depends_on "djocker/php/php73-tidy"
  depends_on "djocker/php/php73-ldap"
