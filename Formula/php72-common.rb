...
class Php72Common < Formula
  ...
  depends_on "djocker/php/php72-gmp"
  depends_on "djocker/php/php72-igbinary"
  depends_on "djocker/php/php72-imagick"
  depends_on "djocker/php/php72-intl"
  depends_on "djocker/php/php72-mcrypt"
  depends_on "djocker/php/php72-mongodb"
  depends_on "djocker/php/php72-opcache"
  depends_on "djocker/php/php72-pdo-pgsql"
  depends_on "djocker/php/php72-sodium"
  depends_on "djocker/php/php72-redis"
  depends_on "djocker/php/php72-tidy"
  depends_on "djocker/php/php72-ldap"
