...
class Php80Common < Formula
  ...
  depends_on "djocker/php/php80"
  depends_on "djocker/php/php80-apcu"
  depends_on "djocker/php/php80-gmp"
  depends_on "djocker/php/php80-igbinary"
  depends_on "djocker/php/php80-imagick"
  depends_on "djocker/php/php80-intl"
  depends_on "djocker/php/php80-mongodb"
  depends_on "djocker/php/php80-opcache"
  depends_on "djocker/php/php80-pdo-pgsql"
  depends_on "djocker/php/php80-sodium"
  depends_on "djocker/php/php80-redis"
  depends_on "djocker/php/php80-tidy"
  depends_on "djocker/php/php80-ldap"
