...
class Php70Mongodb < AbstractPhp70Extension
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, x86_64_linux: "6d7032fafeefbdc5aab603089bafbd59cae2f8afa1c2eff23b921a1f590e738a"
  end
  ...
  def install
    ...
    system "./configure", "--prefix=#{prefix}",
                          phpconfig,
                          "--with-mongodb-ssl=openssl --with-mongodb-icu=#{Formula["digitalspacestdio/common/icu4c@69.1"].opt_prefix}"
    system "make"
