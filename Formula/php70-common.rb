...
class Php70Common < Formula
  ...
  depends_on "djocker/php/php70-apcu"
  depends_on "djocker/php/php70-gmp"
  depends_on "djocker/php/php70-igbinary"
  depends_on "djocker/php/php70-imagick"
  depends_on "djocker/php/php70-intl"
  depends_on "djocker/php/php70-mcrypt"
  depends_on "djocker/php/php70-mongodb"
  depends_on "djocker/php/php70-opcache"
  depends_on "djocker/php/php70-pdo-pgsql"
  depends_on "djocker/php/php70-sodium"
  depends_on "djocker/php/php70-redis"
  depends_on "djocker/php/php70-tidy"
  depends_on "djocker/php/php70-ldap"
